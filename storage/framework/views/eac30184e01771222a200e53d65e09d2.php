                ...
                <div class="w-full">
                    <div class="sm:flex sm:items-center">
                        <div class="sm:flex-auto">
                            <h1 class="text-base font-semibold leading-6 text-gray-900"><?php echo e(__('Listado de Auditorias')); ?></h1>
                            <p class="mt-2 text-sm text-gray-700">Registros</p>
                        </div>
                        <div class="mt-4 sm:ml-4 sm:mt-0 sm:flex space-x-3">
                            <a href="<?php echo e(route('auditorias.reportes')); ?>" 
...
<?php $component->withName('monoicon-document'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
                            ...
                            <div class="inline-block min-w-full py-2 align-middle">
                                <table class="w-full divide-y divide-gray-300">
                                    ...
                                    <?php $__currentLoopData = $auditorias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $auditoria): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										...
										<td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500"><?php echo e($auditoria->movimiento_id); ?></td>
										<td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500"><?php echo e($auditoria->saldo_anterior); ?></td>
										<td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500"><?php echo e($auditoria->saldo_nuevo); ?></td>
										<td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500"><?php echo e($auditoria->fecha_registro); ?></td>

                                            <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900">
                                                <a href="<?php echo e(route('auditorias.show', $auditoria->id)); ?>" class="text-gray-600 font-bold hover:text-gray-900 mr-2"><?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?><?php echo e(__('Show')); ?></a>
                                                ...
                                                <form action="<?php echo e(route('auditorias.destroy', $auditoria->id)); ?>" method="POST" class="form-delete" style="display:inline;">
                                                    <?php echo csrf_field(); ?>
                                                    <?php echo method_field('DELETE'); ?>
...
<?php endif; ?> <?php echo e(__('Delete')); ?>
                                ...
                                <div class="mt-4 px-4">
                                    <?php echo $auditorias->withQueryString()->links(); ?>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\aplicativo\new\app\resources\views/auditoria/index.blade.php ENDPATH**/ ?>