                ...
                <div class="w-full">
                    <div class="sm:flex sm:items-center">
                        <div class="sm:flex-auto">
                            <h1 class="text-base font-semibold leading-6 text-gray-900"><?php echo e(__('Listado de Bancos')); ?></h1>
                            <p class="mt-2 text-sm text-gray-700"><?php echo e(__('Registros')); ?></p>
                        </div>
                        <div class="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
                            <a type="button" href="<?php echo e(route('bancos.create')); ?>" class="block rounded-md bg-indigo-600 px-3 py-2 text-center text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"><?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
                                ...
                                <table class="w-full divide-y divide-gray-300">
                                    ...
                                    <?php $__currentLoopData = $bancos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $banco): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="even:bg-gray-50">
                                            ...
                                            <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500"><?php echo e(ucfirst($banco->tipo_cuenta)); ?></td>
                                            <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500"><?php echo e($banco->numero_cuenta); ?></td>
                                            <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500"><?php echo e(ucfirst($banco->moneda)); ?></td>

                                            <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900">
                                                <a href="<?php echo e(route('bancos.show', $banco->id)); ?>" class="text-gray-600 font-bold hover:text-gray-900 mr-2">
...
<?php endif; ?> <?php echo e(__('Show')); ?>
                                                ...
                                                <a href="<?php echo e(route('bancos.edit', $banco->id)); ?>" class="text-indigo-600 font-bold hover:text-indigo-900 mr-2">
                                                    <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?> <?php echo e(__('Edit')); ?>
                                                ...
                                                <form action="<?php echo e(route('bancos.destroy', $banco->id)); ?>" method="POST" class="form-delete" style="display:inline;">
                                                    <?php echo csrf_field(); ?>
...
<?php endif; ?> <?php echo e(__('Delete')); ?>
                                ...
                                <div class="mt-4 px-4">
                                    <?php echo $bancos->withQueryString()->links(); ?>
...
<?php /**PATH C:\xampp\htdocs\aplicativo\new\app\resources\views/banco/index.blade.php ENDPATH**/ ?>